        ...
        <div class="row text-center">
            <div class="col-sm mt-3 mb-3">
                <div class="btn-group" role="group" aria-label="Группа кнопок с вложенным раскрывающимся списком">
                    ...
                    <button type="button" class="btn btn-secondary">Старые</button>
                ...
                <div class="row ">
                    @foreach($maps as $map)
                        <div class="col-7 col-md-5 col-lg-3" id="map">
                            ...
                            <a class="category" href="{{route('getMapsByCategory', $map->category['slug'])}}" >Жанр: {{$map->category['title']}}</a>
                            ...
                            <div class="text-left">
                                <a href="" target="_blank" class="btn  btn-success btn-block text-light">Скачать</a>
                                <a href="" class="btn  btn-info btn-block text-light">Подробнее...</a>
                            </div>
                        </div>
                    @endforeach
